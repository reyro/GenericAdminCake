<?php $cakeDescription = __d('cake_dev', 'GenericAdminCake'); ?>
<!DOCTYPE html>
<html lang="en-us">
	<head>
<!--		<meta charset="utf-8">-->
		...
		<header id="header">
			...
			<div class="pull-right">
				...
				<ul class="header-dropdown-list hidden-xs">
					<li>
						<a href="#" class="dropdown-toggle" data-toggle="dropdown"> <?php echo $this->Html->image('flags/us.png');?> <span> US </span> <i class="fa fa-angle-down"></i> </a>
						<ul class="dropdown-menu pull-right">
							<li class="active">
								<a href="javascript:void(0);"><?php echo $this->Html->image('flags/us.png');?> US</a>
							</li>
							<li>
								<a href="javascript:void(0);"><?php echo $this->Html->image('flags/es.png');?> Spanish</a>
							</li>
							<li>
								<a href="javascript:void(0);"><?php echo $this->Html->image('flags/de.png');?> German</a>
							</li>
						</ul>
					</li>
				</ul>
...
<!--						<img src="img/avatars/sunny.png" alt="me" class="online" /> -->
		...
		<!-- PACE LOADER - turn this on if you want ajax loading to show (caution: uses lots of memory on iDevices)-->
                <!-- no funciona en otras paginas y no sirve el helper html con eso de true, 
                o talvez si pero no pude. Es solo un efecto, no es muy importante al parecer(abajo)-->
